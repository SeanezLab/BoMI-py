...
class Sample3DWidget(qw.QWidget):
    def __init__(self):
        ...
        self.p2 = p2 = gl.GLSurfacePlotItem(x=x, y=y, z=z, shader="normalColor")
        ...
        self.p3 = p3 = gl.GLSurfacePlotItem(
            z=z, colors=colors.reshape(50 * 50, 4), shader="shaded", smooth=False
        )
        ...
        self._z = z = (
            np.sin(d[np.newaxis, ...] + phi.reshape(phi.shape[0], 1, 1))
            / d2[np.newaxis, ...]
        )
        ...
        self.p4 = p4 = gl.GLSurfacePlotItem(
            x=x[:, 0],
            y=y[0, :],
            shader="heightColor",
